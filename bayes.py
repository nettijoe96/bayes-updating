...
def main():
    h1 = "h1"
    p1, p2, p3, p4, p5 = probDist(generate(h1))
    plime = predictNextLime(p1, p2, p3, p4, p5)
    graph(h1, plime, p1, p2, p3, p4, p5)
    h2 = "h2"
    p1, p2, p3, p4, p5 = probDist(generate(h2))
    plime = predictNextLime(p1, p2, p3, p4, p5)
    graph(h2, plime, p1, p2, p3, p4, p5)
    h3 = "h3"
    p1, p2, p3, p4, p5 = probDist(generate(h3))
    plime = predictNextLime(p1, p2, p3, p4, p5)
    graph(h3, plime, p1, p2, p3, p4, p5)
    h4 = "h4"
    p1, p2, p3, p4, p5 = probDist(generate(h4))
    plime = predictNextLime(p1, p2, p3, p4, p5)
...
def graph(title, plime, p1, p2, p3, p4, p5):
    ...
    plt.title("Prior Updating. Underlying Distribution=" + title)
    plt.legend()
    plt.show()
    plt.plot( x, plime, marker='o', markerfacecolor='green', markersize=6, color='green', linewidth=2, label="h5")
    plt.title("Prediction next is lime. Underlying Distribution=" + title)
    plt.show()
